...
class Categorias extends CI_Controller {
	...
	public function __construct(){
		parent::__construct();
		$this->load->model("Categorias_model"); //constructor carga categoria_model
	}
	...
	public function add(){ //vista agregar categoria
	...
	public function store(){
		...
		if ($this->form_validation->run()==TRUE) {
			...
			/*redirecciona (base_url()."mantenimiento/categorias/add");*/
			$this->add();
		}
