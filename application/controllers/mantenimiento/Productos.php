...
class Productos extends CI_Controller {
	...
	public function __construct(){//constructor carga modelos de productos y categorias
		parent::__construct();
		$this->load->model("Productos_model");
		$this->load->model("Categorias_model");
	}

	public function index()//carga la vista lista de productos
	{
		$data  = array(
	...
	public function add(){//agregar productos relacion categorias
		$data = array( 
